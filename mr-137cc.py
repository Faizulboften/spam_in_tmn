...
\t                               
                              |-----------------------------------|
                              | \033[31;1mData : 20/october/2020  |
                              |-----------------------------------|   
---------------------                              
█▀ █▀█ ▄▀█ █▀▄▀█              |-----------------------------------| 
▄█ █▀▀ █▀█ █░▀░█              | \033[31;1mCreator : Faizul Boften |
                                   | \033[31;1mWhatsapp : 082271426251 |
                                   |-----------------------------------|
----------------------------------
█▄░█ █░█ █▀▄▀█ █▄▄ █▀▀ █▀█
█░▀█ █▄█ █░▀░█ █▄█ ██▄ █▀▄
...
if __name__=="__main__":
     try:
          ...
          time.sleep(4)
          wa2()
          kata("telepone Whatsapp suksesfull")
          time.sleep(4)
          kata("[•]Cair Spam..")
          balik()
     except KeyError:
